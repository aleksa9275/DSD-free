...
begin
  ...
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.FSetActiveControlPoint(Val:TFreeSubdivisionControlPoint) \n');
  CloseFile (LOG);
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.Edit1KeyPress(Sender: TObject;var Key: Char) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.Edit1Exit(Sender: TObject) \n');
  CloseFile (LOG);
   saved := false;
   if ActiveControlPoint<>nil then
   begin
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.Edit2KeyPress(Sender: TObject;var Key: Char) \n');
  CloseFile (LOG);
   if (Key in [#8,'1'..'9','0','-','@',#13]) or
      ((TFreeShip(FreeShip).ProjectSettings.ProjectUnits=fuImperial) and (Key='+')) or
      (Key=Decimalseparator) then else key:=#0; //SAP: added the '@'
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.Edit2Exit(Sender: TObject) \n');
  CloseFile (LOG);
   saved := false;
   if ActiveControlPoint<>nil then
   begin
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.Edit3KeyPress(Sender: TObject; var Key: Char) \n');
  CloseFile (LOG);
   if (Key in [#8,'1'..'9','0','-','@',#13]) or
      ((TFreeShip(FreeShip).ProjectSettings.ProjectUnits=fuImperial) and (Key='+')) or
      (Key=Decimalseparator) then else key:=#0; //SAP: added the '@'
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.Edit3Exit(Sender: TObject) \n');
  CloseFile (LOG);
   saved := false;
   if ActiveControlPoint<>nil then
   begin
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.CheckBox1MouseUp(Sender: TObject;Button: TMouseButton; Shift: TShiftState; X, Y: Integer) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
      // Count the number of crease edges connected to this point
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.SpeedButton1Click(Sender: TObject) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.SpeedButton4Click(Sender: TObject) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
      TFreeShip(FreeShip).Edit.CreateUndoObject(Userstring(190),True);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.SpeedButton2Click(Sender: TObject) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
      TFreeShip(FreeShip).Edit.CreateUndoObject(Userstring(190),True);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.SpeedButton5Click(Sender: TObject) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
      TFreeShip(FreeShip).Edit.CreateUndoObject(Userstring(190),True);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.SpeedButton3Click(Sender: TObject) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
      TFreeShip(FreeShip).Edit.CreateUndoObject(Userstring(190),True);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeControlPointForm.SpeedButton6Click(Sender: TObject) \n');
  CloseFile (LOG);
   if ActiveControlPoint<>nil then
   begin
      TFreeShip(FreeShip).Edit.CreateUndoObject(Userstring(190),True);
