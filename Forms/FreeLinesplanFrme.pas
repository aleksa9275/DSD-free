...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod CalculateSpace(Percentage,Min,Max:TFloatType):TFloatType .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.UpdateMenu .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.FSetFreeShip(Val:TFreeShip) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ViewportRequestExtents(Sender: TObject;var Min, Max: T3DCoordinate) .\n');
    CloseFile(f);
...
var I,J,N,K       : Integer;
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawLineAtt(Attachpoint,P1,P2:T3DCoordinate;Text:string;CenterText:Boolean) .\n');
		CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawDiagonalLine(Origin:T3DCoordinate;P1,P2:T3DCoordinate) .\n');
		CloseFile(f);
      P.X:=Origin.X+P1.Y;
      P.Y:=Origin.Y+P1.Z;
      P.Z:=0.0;
   ...
   begin
      ...
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawLine(P1,P2:T3DCoordinate) .\n');
		CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawSpline(Spline:TFreeSpline;Views:TLinesplanViews;Style:TPenStyle) .\n');
		CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawIntersection(Intersection:TFreeIntersection;Views:TLinesplanViews;Style:TPenStyle) .\n');
		CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod AddTriangle(P1,P2,P3:T3DCoordinate;Color:TColor;var Destination:TriangleArray;Symmetric:boolean) .\n');
		CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod ProcessFace(Face:TFreeSubdivisionFace;Color:TColor;Symmetric:boolean) .\n');
		CloseFile(f);
   ...
   procedure SortTriangles(var Triangles:TriangleArray;SortType:byte);// Sorttype 1=X, 2=Y, 3=Z
      ...
      var I, J : Integer;
       ...
       begin
          AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod Swap(I,J:Integer) .\n');
		CloseFile(f);
      ...
      begin
         AssignFile(f, 'LogFile.txt');
			append(f);
			writeln(f, 'Pozvan metod QuickSort(L,R:Integer) .\n');
			CloseFile(f);
		I:=L;
         J:=R;
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod SortTriangles(var Triangles:TriangleArray;SortType:byte) .\n');
		CloseFile(f);
   ...
   var I       : Integer;
       ...
       begin
          AssignFile(f, 'LogFile.txt');
			append(f);
			writeln(f, 'Pozvan metod GetColor(Lightvector:T3DCoordinate;DpScale,Contrast:TFloatType;Triangle:TriangleData):TColor .\n');
			CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawTriangles(Triangles:TriangleArray;Views:TLinesplanViews) .\n');
		CloseFile(f);
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod SetFontHeight(DesiredHeight:TFloatType) .\n');
		CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ViewportRedraw(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ZoomExtentsExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ZoomInExecute(Sender: TObject) .\n');
    CloseFile(f);
   Viewport.ZoomIn;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ZoomOutExecute(Sender: TObject) .\n');
    CloseFile(f);
   Viewport.ZoomOut;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ShowFillColorExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.PrintExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ViewportMouseMove(Sender: TObject;Shift: TShiftState; X, Y: Integer) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ViewportMouseDown(Sender: TObject;Button: TMouseButton; Shift: TShiftState; X, Y: Integer) .\n');
    CloseFile(f);
   FInitialPosition.X:=X;
   FInitialPosition.Y:=Y;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.SaveBitmapExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.UseLightsExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.ShowMonochromeExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLinesplanFrame.MirrorPlanViewExecute(Sender: TObject) .\n');
    CloseFile(f);
...
var SaveDialog : TSaveDialog;
   ...
   begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod WriteDXFPoint(N:integer;P:T3DCoordinate) .\n');
		CloseFile(f);
    ...
    begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod AddLine(P1,P2:T3DCoordinate;Views:TLinesplanViews;Layername:string;Color:TColor) .\n');
		CloseFile(f);
     if lvProfile in views then
      begin
    ...
    begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod AddSpline(Spline:TFreeSpline;Views:TLinesplanViews;Layername:string;Color:TColor) .\n');
		CloseFile(f);
      NParams:=0;
    ...
    begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod AddEdgeLoop(Points:TFasterList;Views:TLinesplanViews;Layername:string;Color:TColor) .\n');
		CloseFile(f);
      Strings.Add('0'+EOL+'POLYLINE');
      Strings.Add('8'+EOL+LayerName);   // layername
      Strings.Add('62'+EOL+IntToStr(FindDXFColorIndex(Color)));
    ...
    begin
       AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod AddIntersection(Intersection:TFreeIntersection;Views:TLinesplanViews;Layername:string;Color:TColor) .\n');
		CloseFile(f);
	 if not Intersection.Build then Intersection.Rebuild;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod procedure TFreeLinesplanFrame.ExportDXFExecute(Sender: TObject) .\n');
    CloseFile(f);
   Str:=FFreeShip.Preferences.ExportDirectory;
   if Str[Length(Str)]<>'\' then Str:=Str+'\';
