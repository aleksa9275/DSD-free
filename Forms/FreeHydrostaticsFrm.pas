...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FGetStartDraft:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FSetStartDraft(Val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FGetTrim:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FSetTrim(Val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FGetEndDraft:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FSetEndDraft(Val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FGetDraftStep:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FSetDraftStep(Val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Execute(FreeShip:TFreeShip):Boolean .\n');
    CloseFile(f);
   FFreeShip:=Freeship;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Edit1KeyPress(Sender: TObject;var Key: Char) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Button1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOk;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Edit1Exit(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Edit3Exit(Sender: TObject) .\n');
    CloseFile(f);
   DraftStep:=DraftStep;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Edit4Exit(Sender: TObject) .\n');
    CloseFile(f);
   Trim:=Trim;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Edit2Exit(Sender: TObject) .\n');
    CloseFile(f);
   EndDraft:=Enddraft;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.Button2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsForm.FormShow(Sender: TObject) .\n');
    CloseFile(f);
   Edit1.SetFocus;
end;
