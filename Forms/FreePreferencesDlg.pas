...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Updatedata .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Execute(Freeship:TFreeShip):Boolean .\n');
    CloseFile(f);
   FFreeship:=Freeship;
   Updatedata;
   Showmodal;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel4Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel14Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel15Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel5Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel6Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel7Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel8Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel9Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel10Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel11Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel12Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel13Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel16Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel17Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel18Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel19Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel20Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel21Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel22Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel23Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel24Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOk;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel25Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.Panel26Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreePreferencesDialog.SpeedButton3Click(Sender: TObject) .\n');
    CloseFile(f);
