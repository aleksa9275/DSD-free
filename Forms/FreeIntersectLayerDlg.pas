...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.FGetLayer1:TFreeSubdivisionLayer .\n');
    CloseFile(f);
   Result:=nil;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.FGetLayer2:TFreeSubdivisionLayer .\n');
    CloseFile(f);
   Result:=nil;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.UpdateBox2 .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.Execute(Layers:TFasterList):Boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectLayerDialog.ComboBox1Change(Sender: TObject) .\n');
    CloseFile(f);
   UpdateBox2;
