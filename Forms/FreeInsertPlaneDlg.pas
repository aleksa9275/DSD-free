...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.FGetCreateControlcurve:Boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.FGetPlane:T3DPlane .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.FUpdate .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.Execute:Boolean .\n');
    CloseFile(f);
   FUpdate;
   ShowModal;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.RadioButton1Click(Sender: TObject) .\n');
    CloseFile(f);
   FUpdate;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.RadioButton2Click(Sender: TObject) .\n');
    CloseFile(f);
   FUpdate;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.RadioButton3Click(Sender: TObject) .\n');
    CloseFile(f);
   FUpdate;
...
begin
   ...
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.Edit1KeyPress(Sender: TObject; var Key: Char) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   Modalresult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeInsertPlaneDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
