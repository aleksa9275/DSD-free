...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.UpdateMenu .\n');
    CloseFile(f);
   N:=0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Execute(FreeShip:TFreeShip):Boolean .\n');
    CloseFile(f);
   FFreeShip:=FreeShip;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.FFillBox .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.FGetSelectedLayer:TFreeSubdivisionLayer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.LayerBoxClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.LayerBoxDblClick(Sender: TObject) .\n');
    CloseFile(f);
   if Layerbox.ItemIndex<>-1 then
   begin
      Layer:=Layerbox.Items.Objects[Layerbox.ItemIndex] as TFreeSubdivisionLayer;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Edit1Change(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Panel3Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.CheckBox1Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
	AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.ToolButton20Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.ToolButton1Click(Sender: TObject) .\n');
    CloseFile(f);
   Modalresult:=mrOK;
...
begin
	AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.ToolButton3Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.CheckBox2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.CheckBox3Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Edit2KeyPress(Sender: TObject; var Key: Char) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Edit2Exit(Sender: TObject) .\n');
    CloseFile(f);
   if SelectedLayer<>nil then
   begin
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Edit3KeyPress(Sender: TObject; var Key: Char) .\n');
    CloseFile(f);
   if (Key in [#8,'1'..'9','0',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.Edit3Exit(Sender: TObject) .\n');
    CloseFile(f);
   if SelectedLayer<>nil then
   begin
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.MoveUpClick(Sender: TObject) .\n');
    CloseFile(f);
   if SelectedLayer<>nil then
   begin
      Layer:=SelectedLayer;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.MoveDownClick(Sender: TObject) .\n');
    CloseFile(f);
   if SelectedLayer<>nil then
   begin
      Layer:=SelectedLayer;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.CheckBox4Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.CheckBox5Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLayerDialog.AlphaBarChange(Sender: TObject) .\n');
    CloseFile(f);
