...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.CheckDisplacements(var Data:TFloatArray;var NData:Integer) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.GetDisplacements(var Data:TFloatArray;var NData:Integer) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.SetDisplacements(Data:TFloatArray;NData:Integer) \n');
  CloseFile (LOG);
   CheckDisplacements(Data,NData);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.ToolButton25Click(Sender: TObject) \n');
  CloseFile (LOG);
   ModalResult:=mrOK;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.ToolButton7Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.Button1Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.Button2Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.UpdateDisplacementData \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.UpdateHeelingAngleData \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.CheckBox1Click(Sender: TObject) \n');
  CloseFile (LOG);
   UpdateDisplacementData;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.DisplBoxMouseDown(Sender: TObject;Button: TMouseButton; Shift: TShiftState; X, Y: Integer) \n');
  CloseFile (LOG);
   UpdateDisplacementData;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.CheckHeelingAngles(var Data:TFloatArray;var NData:Integer) \n');
  CloseFile (LOG);
   SortFloatArray(Data,NData);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.GetHeelingAngles(var Data:TFloatArray;var NData:Integer) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.SetHeelingAngles(Data:TFloatArray;NData:Integer) \n');
  CloseFile (LOG);
   CheckHeelingAngles(Data,NData);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.Button3Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.Button4Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.HeelBoxClick(Sender: TObject) \n');
  CloseFile (LOG);
   UpdateHeelingAngleData;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.ToolButton1Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.GridDrawCell(Sender: TObject; ACol,ARow: Integer; Rect: TRect; State: TGridDrawState) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.PrintButtonClick(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.ToolButton2Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeCrosscurvesDialog.SaveButtonClick(Sender: TObject) \n');
  CloseFile (LOG);
