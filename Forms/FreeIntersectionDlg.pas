...
begin
	...
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.UpdateMenu .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.FillBox .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.Execute(FreeShip:TFreeShip) .\n');
    CloseFile(f);
   FFreeShip:=FreeShip;
   FillBox;
   UpdateMenu;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.ListBoxKeyDown(Sender: TObject;var Key: Word; Shift: TShiftState) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.ListBoxClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.ViewStationsExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.ViewButtocksExecute(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.ViewWaterlinesExecute(Sender: TObject) .\n');
    CloseFile(f);
   ViewStations.Checked:=False;
   ViewButtocks.Checked:=False;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.ViewDiagonalsExecute(Sender: TObject) .\n');
    CloseFile(f);
   ViewStations.Checked:=False;
   ViewButtocks.Checked:=False;
   ViewWaterlines.Checked:=False;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.CloseDialogExecute(Sender: TObject) .\n');
    CloseFile(f);
    Close;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.AddOneExecute(Sender: TObject) .\n');
    CloseFile(f);
   Str:='1.0';
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.AddRangeExecute(Sender: TObject) .\n');
    CloseFile(f);
   Str:='1.0';
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeIntersectionDialog.DeleteAllExecute(Sender: TObject) .\n');
    CloseFile(f);
   if ViewStations.Checked then
   begin
