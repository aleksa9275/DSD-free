...
AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.FCaptionText:string \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.SetCaption \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.FSetFreeShip(Val:TFreeShip) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.UpdateMenu \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportRequestExtents(Sender: TObject; var Min,Max: T3DCoordinate) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportRedraw(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.FormCreate(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.FormClose(Sender: TObject; var Action: TCloseFileAction) \n');
  CloseFile (LOG);
   // Disconnect from FreeShip component;
   Freeship:=nil;
   Action:=caFree;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.PopupMenuPopup(Sender: TObject) \n');
  CloseFile (LOG);
   UpdateMenu;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.StandardLensExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.WideLensExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ShortTeleLensExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.MediumTeleLensExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.LongTeleLensExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewBodyPlanExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewProfileExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewPlanExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewPerspectiveExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.FormShow(Sender: TObject) \n');
  CloseFile (LOG);
   SetCaption;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportChangeViewType(Sender: TObject) \n');
  CloseFile (LOG);
   SetCaption;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ZoomInExecute(Sender: TObject) \n');
  CloseFile (LOG);
   Viewport.ZoomIn;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ZoomExtentsExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ZoomOutExecute(Sender: TObject) \n');
  CloseFile (LOG);
   Viewport.ZoomOut;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportMouseDown(Sender: TObject;Button: TMouseButton; Shift: TShiftState; X, Y: Integer) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportMouseMove(Sender: TObject;Shift: TShiftState; X, Y: Integer) \n');
  CloseFile (LOG);
...
begin
 AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportMouseUp(Sender: TObject;Button: TMouseButton; Shift: TShiftState; X, Y: Integer) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.DeselectAllExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportMouseLeave(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.PrintExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ShowWireFrameExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ShowFlatShadeExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ShowGaussCurvatureExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ShowDevelopablityExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.SaveAsBitmapExecute(Sender: TObject) \n');
  CloseFile (LOG);
   // Skip translation
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportKeyUp(Sender: TObject; var Key: Word;Shift: TShiftState) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportKeyPress(Sender: TObject; var Key: Char) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ShadeZebraExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ImportBackGroundExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundOriginExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundScaleExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundTransparentColorExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundclearExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundBlendingExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportRequestBackgroundImage(Sender: TObject) \n');
  CloseFile (LOG);
   if Freeship<>nil then
   begin
      Data:=nil;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.ViewportChangeBackground(Sender: TObject)n \n');
  CloseFile (LOG);
   for I:=1 to Freeship.NumberofBackgroundImages do if Freeship.BackgroundImage[I-1].AssignedView=Viewport.ViewType then
   begin
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundExportExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundToleranceExecute(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeHullWindow.BackgroundVisibleExecute(Sender: TObject) \n');
  CloseFile (LOG);
