...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.CorrectInputdata:boolean .\n');
    CloseFile(f);
   Result:=False;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.Calculate .\n');
    CloseFile(f);
   Series1.Clear;
   Series2.Clear;
   Series3.Clear;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetStartSpeed:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetStartSpeed(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetEndSpeed:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetEndSpeed(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetDensity:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetDensity(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetDisplacement:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetDisplacement(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetDraft:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetDraft(val:single) .\n');
    CloseFile(f);
   Draftbox.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetDraftTotal:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetDraftTotal(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetLwl:single .\n');
    CloseFile(f);
   Result:=Lwlbox.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetLwl(val:single) .\n');
    CloseFile(f);
   Lwlbox.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetLCB:single .\n');
    CloseFile(f);
   Result:=LCBbox.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetLCB(val:single) .\n');
    CloseFile(f);
   LCBbox.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetKeelChordLength:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetKeelChordLength(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetKeelArea:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetKeelArea(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetRudderChordLength:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetRudderChordLength(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetRudderArea:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetRudderArea(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetBwl:single .\n');
    CloseFile(f);
   Result:=Bwlbox.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetBwl(val:single) .\n');
    CloseFile(f);
   Bwlbox.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetCp:single .\n');
    CloseFile(f);
   Result:=Cpbox.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetCp(val:single) .\n');
    CloseFile(f);
   Cpbox.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetViscosity:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetViscosity(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetWettedSurface:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetWettedSurface(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetWlArea:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetWlArea(val:single) .\n');
    CloseFile(f);
   WlAreabox.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetStepSpeed:single .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetStepSpeed(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FGetExtractFromHull:boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.FSetExtractFromHull(Val:Boolean) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.Execute(Freeship:TFreeship;AutoExtract:Boolean):Boolean .\n');
    CloseFile(f);
   FFreeship:=Freeship;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.CalculateResistance(ConvertedSpeed,LCB,Cp:single;var Rf,Rr,Rt: single) .\n');
    CloseFile(f);
   Rf:=0.0;
   Rr:=0.0;
   Rt:=0.0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.OptimumCP(Speed:single):single .\n');
    CloseFile(f);
   result:=0;
   exit;
   RMin:=1e1000;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.OptimumLCB(Speed:single):single .\n');
    CloseFile(f);
   result:=0;
   exit;
   RMin:=1e1000;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.CheckBox2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.ToolButton25Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOk;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.ToolButton7Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.ToolButton20Click(Sender: TObject) .\n');
    CloseFile(f);
   Calculate;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.PrintButtonClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.DraftTotalBoxAfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.StartSpeedBoxAfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Calculate;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.LwlBoxAfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Calculate;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.KeelChordLengthboxAfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Calculate;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Delft.EstimateBoxClick(Sender: TObject) .\n');
    CloseFile(f);
