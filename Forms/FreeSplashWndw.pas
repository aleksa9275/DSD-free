...
begin
 AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod SetTransparentForm(AHandle : THandle; AValue : byte = 0) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSplashWindow.TimerTimer(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSplashWindow.FormClose(Sender: TObject;var Action: TCloseAction) .\n');
    CloseFile(f);
   Timer.Enabled:=False;
   Release;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSplashWindow.Image1Click(Sender: TObject) .\n');
    CloseFile(f);
   Timer.Enabled:=False;
   Close;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSplashWindow.FormShow(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSplashWindow._Label5Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSplashWindow._Label4Click(Sender: TObject) .\n');
    CloseFile(f);
   // Send an email
   // Skip translation
