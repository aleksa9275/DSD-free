...
AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.FGetXValue:extended \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.FSetXValue(val:extended) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.FGetYValue:extended \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.FSetYValue(val:extended) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.FGetZValue:extended \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.FSetZValue(val:extended) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Execute(Str:string):Boolean \n');
  CloseFile (LOG);
   _label3.Caption:=Str;
   _label6.Caption:=Str;
   _label9.Caption:=Str;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit1KeyPress(Sender: TObject; var Key: Char) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit1Exit(Sender: TObject) \n');
  CloseFile (LOG);
   XValue:=self.XValue;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit1KeyDown(Sender: TObject; var Key: Word;Shift: TShiftState) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit2Exit(Sender: TObject) \n');
  CloseFile (LOG);
  inherited;
   YValue:=self.YValue;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit3Exit(Sender: TObject) \n');
  CloseFile (LOG);
   ZValue:=self.ZValue;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.OKButtonClick(Sender: TObject) \n');
  CloseFile (LOG);
   ModalResult:=mrOk;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.CancelButtonClick(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit2KeyPress(Sender: TObject; var Key: Char) \n');
  CloseFile (LOG);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.Edit3KeyPress(Sender: TObject; var Key: Char) \n');
  CloseFile (LOG);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.BitBtn1Click(Sender: TObject) \n');
  CloseFile (LOG);
   ModalResult:=mrOK;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeExtrudeDialog.BitBtn2Click(Sender: TObject) \n');
  CloseFile (LOG);
   ModalResult:=mrCancel;
