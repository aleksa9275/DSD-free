...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FBuildOffsets .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetDraft:single .\n');
    CloseFile(f);
   Result:=Edit3.value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetDraft(val:single) .\n');
    CloseFile(f);
   if Val<0 then Val:=0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetG:single .\n');
    CloseFile(f);
   Result:=Edit6.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetG(val:single) .\n');
    CloseFile(f);
   Edit6.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetR0:single .\n');
    CloseFile(f);
   Result:=Edit15.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetR0(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetX0:single .\n');
    CloseFile(f);
   Result:=Edit20.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetX0(val:single) .\n');
    CloseFile(f);
   if Val<1.5*Length then Val:=1.5*Length;
   Edit20.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetX1:single .\n');
    CloseFile(f);
   Result:=Edit21.value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetX1(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetY0:single .\n');
    CloseFile(f);
   Result:=Edit22.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetY0(val:single) .\n');
    CloseFile(f);
   Edit22.Value:=Val;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetY1:single .\n');
    CloseFile(f);
    Result:=Edit23.Value;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetY1(val:single) .\n');
    CloseFile(f);
    Edit23.Value:=val;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetBeta:single .\n');
    CloseFile(f);
    Result:=Edit17.Value;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetBeta(val:single).\n');
    CloseFile(f);
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetR1:single .\n');
    CloseFile(f);
    Result:=Edit16.Value;
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetR1(val:single) .\n');
    CloseFile(f);
    if Val<2.5*Length then Val:=2.5*Length;
   Edit16.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetLength:single .\n');
    CloseFile(f);
   Result:=edit4.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetLength(val:single) .\n');
    CloseFile(f);
   if val<0 then Val:=0;
   Edit4.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetWaterViscosity:single .\n');
    CloseFile(f);
   Result:=Edit8.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetWaterViscosity(val:single) .\n');
    CloseFile(f);
   Edit8.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetWaterDensity:single .\n');
    CloseFile(f);
   Result:=Edit7.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetWaterDensity(val:single) .\n');
    CloseFile(f);
   Edit7.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetVolume:single .\n');
    CloseFile(f);
   Result:=Edit5.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetVolume(val:single) .\n');
    CloseFile(f);
   Edit5.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetStartSpeed:single .\n');
    CloseFile(f);
   Result:=Edit12.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetStartSpeed(val:single) .\n');
    CloseFile(f);
   Edit12.Value:=Val;
   // Skip translation
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetEndSpeed:single .\n');
    CloseFile(f);
   Result:=Edit13.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetEndSpeed(val:single) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetWaterDepth:single .\n');
    CloseFile(f);
   Result:=Edit9.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetWaterDepth(val:single) .\n');
    CloseFile(f);
   Edit9.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNumberOfStations:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNumberOfStations(val:Integer) .\n');
    CloseFile(f);
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNumberOfSpeeds:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNumberOfSpeeds(val:Integer) .\n');
    CloseFile(f);
   Edit14.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNr:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNr(val:Integer) .\n');
    CloseFile(f);
   Edit18.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNx:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNx(val:Integer) .\n');
    CloseFile(f);
   Edit24.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNy:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNy(val:Integer) .\n');
    CloseFile(f);
   Edit25.Value:=Val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNBeta:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNBeta(val:Integer) .\n');
    CloseFile(f);
   Edit19.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetNumberOfWaterlines:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FSetNumberOfWaterlines(val:Integer) .\n');
    CloseFile(f);
   if not odd(val) then inc(val);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Execute(Freeship:TFreeShip):Boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.OKbuttonClick(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.CancelButtonClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.ViewportRequestExtents(Sender: TObject;var Min, Max: T3DCoordinate) .\n');
    CloseFile(f);
   if FFreeship=nil then exit;
   Min.X:=0.0;
   Min.Y:=0.0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.ViewportRedraw(Sender: TObject) .\n');
    CloseFile(f);
   if FFreeship=nil then exit;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.SaveToFile(Filename:string) .\n');
    CloseFile(f);
   if FFreeship=nil then exit;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FGetMultihull:boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.RadioButton1Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.DistanceAfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   FBuildOffsets;
   viewport.Zoomextents;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit1AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit2AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit3AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Draft:=Edit3.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit7AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit4AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Length:=Edit4.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit5AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Volume:=Edit5.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit6AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   G:=Edit6.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit9AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit12AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit13AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit14AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit15AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   R0:=Edit15.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit16AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   R1:=Edit16.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit17AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Beta:=Edit17.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit18AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Nr:=Edit18.AsInteger;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit19AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit20AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   X0:=Edit20.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit21AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   X1:=Edit21.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit22AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Y0:=Edit22.value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit23AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Y1:=Edit23.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit24AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Nx:=Edit24.AsInteger;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.Edit25AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   Ny:=Edit25.AsInteger;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeMichletOutputDialog.FormResize(Sender: TObject) .\n');
    CloseFile(f);
