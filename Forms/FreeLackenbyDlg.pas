...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.FCalulateHydrostaticProperties(Wlplane:T3DPlane;MainArea:TFloatType;Stations:TFasterList;var Prop:TBodyProp;SAC:TFreeSpline) .\n');
    CloseFile(f);
   N:=Stations.Count;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.FCopyValues .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.FUpdateDifferences .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.FUpdateData .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.FExtractStations(Dest:TFasterList) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.FExtractWaterline(Dest:TFasterList) .\n');
    CloseFile(f);
   for I:=1 to Dest.Count do
   begin
      Spline:=Dest[I-1];
...
var Point         : TFreeSubdivisionControlPoint;
    ...
    begin
       AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod InitializeData(var Prop:TBodyProp) .\n');
		CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.Transform(NewDispl:TFloatType;MaxIterations:Integer;UpdateWindows:Boolean;var Succeeded:Boolean) .\n');
    CloseFile(f);
   Succeeded:=False;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.Execute(Freeship:TFreeship;var Modified:boolean):Boolean .\n');
    CloseFile(f);
   FFreeship:=Freeship;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.OKButtonClick(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOk;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.CancelButtonClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrCancel;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.Button1Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.Input1AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   if Input1.Value>0 then
   begin
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.Input2AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.Input3AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.ViewportRequestExtents(Sender: TObject;var Min, Max: T3DCoordinate) .\n');
    CloseFile(f);
   First:=True;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.ViewportRedraw(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.TopViewRequestExtents(Sender: TObject;var Min, Max: T3DCoordinate) .\n');
    CloseFile(f);
   First:=True;
   for I:=1 to FFreeship.NumberOfLayers do
   begin
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeLackenbyDialog.TopViewRedraw(Sender: TObject) .\n');
    CloseFile(f);
