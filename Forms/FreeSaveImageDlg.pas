...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.SetImageSize .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.FGetFilename:string .\n');
    CloseFile(f);
   Result:=Edit3.Text;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.FGetImageWidth:integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.FSetImageWidth(val:integer) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.FSetFilename(val:string) .\n');
    CloseFile(f);
   Edit3.Text:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.FGetImageHeight:integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.FSetImageHeight(val:integer) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.Execute:Boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.Edit1KeyPress(Sender: TObject; var Key: Char) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.Edit1Exit(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.Edit1KeyDown(Sender: TObject; var Key: Word;Shift: TShiftState) .\n');
    CloseFile(f);
...
begin
  AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.Edit2Exit(Sender: TObject) .\n');
    CloseFile(f);
   inherited;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.SpeedButton1Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOk;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TSaveImageDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
