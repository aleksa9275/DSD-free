...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsResultsDialog.GridDrawCell(Sender: TObject;ACol, ARow: Integer; Rect: TRect; State: TGridDrawState) .\n');
    CloseFile(f);
...
begin
   ...
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsResultsDialog.Execute:Boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsResultsDialog.FormResize(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsResultsDialog.Button1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsResultsDialog.SpeedButton2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeHydrostaticsResultsDialog.SpeedButton1Click(Sender: TObject) .\n');
    CloseFile(f);
