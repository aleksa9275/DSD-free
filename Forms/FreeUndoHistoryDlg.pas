...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.Execute(Freeship:TFreeShip):Boolean .\n');
    CloseFile(f);
   UndoBox.Clear;
   try
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.UndoBoxClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.ViewportRequestExtents(Sender: TObject;var Min, Max: T3DCoordinate) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.ViewportRedraw(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.SpeedButton1Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.SpeedButton2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeUndoHistoryDialog.FormResize(Sender: TObject) .\n');
    CloseFile(f);
