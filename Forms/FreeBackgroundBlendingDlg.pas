...
begin
  ...
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeBackgroundBlendDialog.Execute(Viewport:TFreeViewport):Boolean \n');
  CloseFile (LOG);
  FViewport:=Viewport;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeBackgroundBlendDialog.BitBtn1Click(Sender: TObject) \n');
  CloseFile (LOG);
  ModalResult:=mrOk;
...
AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeBackgroundBlendDialog.BitBtn2Click(Sender: TObject) \n');
  CloseFile (LOG);
...
AssignFile (LOG,'LogFile.txt');
  Append (LOG);
  Writeln (LOG,'Pozvan je metod TFreeBackgroundBlendDialog.TrackBar1Change(Sender: TObject) \n');
  CloseFile (LOG);
