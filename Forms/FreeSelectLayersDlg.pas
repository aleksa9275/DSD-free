...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.FGetNumberOfLayers:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.FGetSelected(Index:Integer):boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.FGetLayer(Index:Integer):TFreeSubdivisionLayer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.FFillBox .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.FUpdateSelection(Destination:TFasterList) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.Execute(Freeship:TFreeShip;SelectMode:TFreeSelectMode):Boolean .\n');
    CloseFile(f);
   FFreeship:=Freeship;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.ExtractSelectedFaces(var Destination:TFasterList) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.ExtractSelectedPoints(var Destination:TFasterList) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   Modalresult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.LayerBoxClickCheck(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeSelectLayersDialog.CheckBoxClick(Sender: TObject) .\n');
    CloseFile(f);
