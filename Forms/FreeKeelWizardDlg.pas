...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.FGetCols:Integer .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.FGetRows:Integer .\n');
    CloseFile(f);
...
var L,a,b      : TFloatType;
    ...
    begin
       AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod ProcessTriangle(P1,P2,P3:T3DCoordinate) .\n');
		CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.UpdateData .\n');
    CloseFile(f);
   FProfile.Clear;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.Execute(Freeship:TFreeShip):Boolean .\n');
    CloseFile(f);
   FFreeship:=Freeship;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   Modalresult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.ComboBox1Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.Input1AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   UpdateData;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.ViewportRequestExtents(Sender: TObject; var Min, Max: T3DCoordinate) .\n');
    CloseFile(f);
...
procedure TFreeKeelWizardDialog.ViewportRedraw(Sender: TObject);
    ...
    begin
      AssignFile(f, 'LogFile.txt');
		append(f);
		writeln(f, 'Pozvan metod DrawPoint(P:T3DCoordinate;Text:string) .\n');
		CloseFile(f);
...
begin
   ...
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.ViewportRedraw(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.SpeedButton1Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.Input5AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   UpdateData;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.Input6AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
   UpdateData;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.TrackBar1Change(Sender: TObject) .\n');
    CloseFile(f);
   UpdateData;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.SendToSurface(Surface:TFreeSubdivisionsurface) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeKeelWizardDialog.SpeedButton2Click(Sender: TObject) .\n');
    CloseFile(f);
