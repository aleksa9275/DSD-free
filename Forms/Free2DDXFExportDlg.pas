...
begin
  ...
  Append(LOG);
  Writeln (LOG,'Pozvan je metod BrowseForFolderCallBack(Wnd: HWND; uMsg: UINT;lParam, lpData: LPARAM): Integer stdcall - klasa Free2DDXFExportDlg \n');
  CloseFile (LOG);
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.BrowseForFolder(Const browseTitle: PAnsiChar;initialFolder: String=''): String -klasa Free2DDXFExportDlg \n');
  CloseFile (LOG);
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.FGetExportDirectory klasa Free2DDXFExportDlg \n');
  CloseFile (LOG);
   Result:=Edit3.Text;
...
begin
  AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.FSetExportDirectory(val:string) \n');
  CloseFile (LOG);
   Edit3.Text:=Val;
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.FGetSegmentLength:double \n');
  CloseFile (LOG);
   Result:=Edit1.Value;
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.FSetSegmentLength(val:double) \n');
  CloseFile (LOG);
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.FSetUnits \n');
  CloseFile (LOG);
   Str:=ComboBox1.Text;
   Label3.Caption:=Str;
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.Execute:Boolean \n');
  CloseFile (LOG);
   FSetUnits;
   Showmodal;
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.SpeedButton1Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.BitBtn1Click(Sender: TObject) \n');
  CloseFile (LOG);
   ModalResult:=mrOk;
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.BitBtn2Click(Sender: TObject) \n');
  CloseFile (LOG);
...
begin
   AssignFile (LOG,'LogFile.txt');
  Append(LOG);
  Writeln (LOG,'Pozvan je metod TDXFExport2DDialog.ComboBox1Change(Sender: TObject) \n');
  CloseFile (LOG);
   FSetUnits;
