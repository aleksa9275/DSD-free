...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetConversionFactor:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetBeam:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetBeam(Val:double) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetCoefficient:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetCoefficient(Val:double) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetDensity:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetDensity(Val:double) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetDraft:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetDraft(Val:double) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetLength:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetLength(Val:double) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FGetMainframe:double .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetMainframe(Val:double) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FSetUnitCaptions .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Execute:Boolean .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit2KeyPress(Sender: TObject;var Key: Char) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit2Exit(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit3KeyPress(Sender: TObject; var Key: Char) .\n');
    CloseFile(f);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.EditExit(Sender: TObject) .\n');
    CloseFile(f);
   Beam:=Beam;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit4KeyPress(Sender: TObject;  var Key: Char) .\n');
    CloseFile(f);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit4Exit(Sender: TObject) .\n');
    CloseFile(f);
   Draft:=Draft;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit5KeyPress(Sender: TObject;var Key: Char) .\n');
    CloseFile(f);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit5Exit(Sender: TObject) .\n');
    CloseFile(f);
   Density:=Density;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit6KeyPress(Sender: TObject;var Key: Char) .\n');
    CloseFile(f);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit6Exit(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Panel4Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.UnitboxClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit8Exit(Sender: TObject) .\n');
    CloseFile(f);
   Mainframe:=Mainframe;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.Edit8KeyPress(Sender: TObject;var Key: Char) .\n');
    CloseFile(f);
   if (Key in [#8,'1'..'9','0','-',#13]) or (Key=DecimalSeparator) then else key:=#0;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.CheckBox2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.BitBtn1Click(Sender: TObject) .\n');
    CloseFile(f);
   Modalresult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.BitBtn2Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFREEProjectSettingsDialog.FormShow(Sender: TObject) .\n');
    CloseFile(f);
