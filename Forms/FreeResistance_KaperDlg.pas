...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetLCB:single .\n');
    CloseFile(f);
   Result:=Edit9.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetLCB(val:single) .\n');
    CloseFile(f);
   Edit9.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetle:single .\n');
    CloseFile(f);
   Result:=Edit8.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetle(val:single) .\n');
    CloseFile(f);
   Edit8.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetEwl:single .\n');
    CloseFile(f);
   Result:=Edit2.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetEwl(val:single) .\n');
    CloseFile(f);
   Edit2.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetBwl:single .\n');
    CloseFile(f);
   Result:=Edit3.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetBwl(val:single) .\n');
    CloseFile(f);
   Edit3.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetAt_Ax:single .\n');
    CloseFile(f);
   Result:=Edit10.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetAt_Ax(val:single) .\n');
    CloseFile(f);
   Edit10.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetH:single .\n');
    CloseFile(f);
   Result:=Edit4.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetH(val:single) .\n');
    CloseFile(f);
   Edit4.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetWs:single .\n');
    CloseFile(f);
   Result:=Edit5.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetWs(val:single) .\n');
    CloseFile(f);
   Edit5.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.Calculate .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.Execute(Freeship:TFreeship;AutoExtract:Boolean):Boolean .\n');
    CloseFile(f);
   FFreeship:=Freeship;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetCp:single .\n');
    CloseFile(f);
   Result:=Edit6.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetCp(val:single) .\n');
    CloseFile(f);
   Edit6.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FGetDispl:single .\n');
    CloseFile(f);
   Result:=Edit7.Value;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.FSetDispl(val:single) .\n');
    CloseFile(f);
   Edit7.Value:=val;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.ToolButton25Click(Sender: TObject) .\n');
    CloseFile(f);
   ModalResult:=mrOK;
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.ToolButton7Click(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.Edit1AfterSetValue(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.PrintButtonClick(Sender: TObject) .\n');
    CloseFile(f);
...
begin
   AssignFile(f, 'LogFile.txt');
	append(f);
	writeln(f, 'Pozvan metod TFreeResistance_Kaper.CheckBox2Click(Sender: TObject) .\n');
    CloseFile(f);
